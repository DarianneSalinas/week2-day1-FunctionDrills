...
function add (item1, item2) {
  let convertItem1 = Number(item1)
  let convertItem2 = Number(item2)
  return convertItem1 + convertItem2;
}
let sum = add(3,6)
console.log(sum)
...
console.log(exclaimThree("Doggos"));
...
const bestMovie = movieStr => {
  return `${movieStr} is the best movie ever!`
}

console.log(bestMovie("The Devil Wears Prada"))
...
function emailCheck(email) {
  const emailParam = String(email.trim());
...
console.log(emailCheck("     s@duntain.com     "))
...
function goldSpent(gold) {
const chocolateFrogCost = 3
  return gold / chocolateFrogCost
}

let totalFrogs = goldSpent(10)
...
function goldSpent(gold) {
  const chocolateFrogCost = 3
    return (parseInt(gold / chocolateFrogCost))
  }
  
  let totalFrogs2 = goldSpent(4)
...
/*
  ...
  Create a variable, `arrayIsAscending` and set it equal to your function invoked. Use the sample array to test 
  this function.
*/
let ascending = false
...
let arrayIsAscending =  numArr(sampleArray)
